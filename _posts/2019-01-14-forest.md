...
The big advantage to this is the short processing time. But the drawback, we are losing any knowledge regarding our features. Now is that important? Maybe.
...
What conclusion can we draw out of this? Yes, we can build a model that predicts what types of trees grow in an area based on the surrounding characteristics.
