...
![Count Category]({{ site.baseimg }}/images/content_by_url_count.png)
{: refdef}
...
{:refdef: style="text-align: center;"}
![Count Category]({{ site.baseimg }}/images/content_by_article_count.png)
{: refdef}
...
{:refdef: style="text-align: center;"}
![Count Category]({{ site.baseimg }}/images/Positive-Neutral-Negative_Content_Distribution.png)
{: refdef}
...
{:refdef: style="text-align: center;"}
![Count Category]({{ site.baseimg }}/images/posneg_sentiment.png)
{: refdef}
